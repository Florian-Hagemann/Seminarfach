...
in der Verfassung der Vereinigten Staaten von Amerika verankert \autocite[vgl.][1. Zusatzartikel]{USConst}. Jedoch ist die Religion
...
Marcus Calpurnius Bibulus im Jahr 59 v. Chr., wo Bibulus durch falsche Vogelschauten, auch Auspizien (von dem lateinischen \textit{auspicia} (Plural), Singular \textit{auspicium} "Vogelschau", von lateinisch \textit{avis} "Vogel"\ und \textit{spectare} "{schauen}") genannt, versuchte Caesars Gesetzentwürfe zu verhindern. Auch wenn es Bibulus nicht gelang Caesar aufzuhalten, war dies nicht die Norm. Ein typischeres Beispiel fand zwischen den Jahren 57 v. Chr. und 56 v. Chr. statt: Quintus Caecilius Metellus Nepos wurde drei Monate lang von seinem politischen Rivalen Titus Annius Milo daran gehindert Wahlen zu halten\autocite[vgl.][127-128]{DriedigerAugury2019}.

\section{Leitfrage}
Wir sehen also, obwohl zwischen beiden Staaten mehr als 1500 Jahre liegen, dass Religion in der Politik beider Länder eine Rolle spielt. Daher stellt sich die Frage: Welche Muster können wir heute wiederfinden? In der Seminararbeit wird dabei auf die Motive der Akteure, auf die Vorgehensweise, und die Effekte eingegangen.

\section{Relevanz}
Auch wenn die politischen Systeme der USA und der römischen Republik sich stark unterscheiden, ist der Vergleich zwischen beiden im Bezug auf die Instrumentalisierung von Religion dennoch eine Möglichkeit diese besser zu verstehen und begünstigende Faktoren zu erkennen.
